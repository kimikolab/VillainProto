...
public static void Run(string[] args, int stageIndex)
{
    ...
    var hcLabel = new Dictionary<TraitId, (int L, string Why)>
    {
        ...
        [TraitId.PlankBase]       = (HcPlusL,  "板の基本の厚さを自分の最大HPの4割にする札（第210期）"),
        [TraitId.FirstAid]        = (HcPlusL,  "破片の無い味方がHPの4割を切ると手番の外で板を貼る札（第210期）"),
        [TraitId.PlankSkill]      = (HcPlusL,  "板が砕かれた累計で基本の厚さが伸びる札（第210期）"),
        [TraitId.PlankNeediest]   = (HcPlusL,  "手番の板を HP と破片を合わせて最も少ない味方に貼る札（第211期）"),
        [TraitId.FirstAidArmored] = (HcPlusL,  "応急処置の条件を HP と破片の合計で見る札（第211期）"),
        [TraitId.ThornsArmored]   = (HcPlusL,  "破片で受け切った一撃にも棘を返す札（第211期）"),
        ...
        [TraitId.GurenOpening]    = (HcPlusL,  "開戦時に敵全体へ毒 1 を撒く札（第216期・O1・保持者 0 枚）"),
        [TraitId.GurenOpeningAll] = (HcBothL,  "開戦時に敵味方の全体へ毒 1 を撒く札（第216期・O2・結界の外の味方は削られる・保持者 0 枚）"),
        [TraitId.GurenOpeningAll3]= (HcBothL,  "開戦時に敵味方の全体へ毒 3 を撒く札（第216期・O3・保持者 0 枚）"),
        [TraitId.GurenOpeningBurn]= (HcPlusL,  "開戦時に敵全体へ毒 1 と火を撒く札（第216期・O4・保持者 0 枚）"),
        [TraitId.ShockStun]       = (HcBothL,  "感電が弾けた連鎖の起点を痺れさせる札（第216期・S1・敵味方を問わない・保持者 0 枚）"),
        [TraitId.ShockStunAll]    = (HcBothL,  "感電が弾けた駒すべてを痺れさせる札（第216期・S2・敵味方を問わない・保持者 0 枚）"),
        [TraitId.ShockStunHalf]   = (HcBothL,  "感電が弾けた駒を 50% で痺れさせる札（第216期・S3・敵味方を問わない・保持者 0 枚）"),
        [TraitId.Scourge]         = (HcBothL,  "動けない敵には2倍で入り、動ける主目標を打つと怖気づくのが1つの規則（第217期・責め苦の追い打ちを1発にまとめた版・保持者 0 枚）"),
        [TraitId.Lash]            = (HcPlusL,  "鞭（第217期）: 攻撃型は常に薙ぎ・動けない敵を優先して狙い、悲鳴は当たった動けない敵から1手番に1回（保持者 0 枚）"),
        [TraitId.LiveWire]        = (HcPlusL,  "電気鞭（第217期）: 感電していれば怖気づかず、当たった敵に感電を移して自分の感電を使い切る（保持者 0 枚）"),
        [TraitId.LiveWireGuard]   = (HcBothL,  "感電の痺れのハメ防止（第217期・G3H）: 痺れが明けた駒は次の自分の手番まで感電で痺れない。敵味方を問わない（保持者 0 枚）"),
        [TraitId.ScourgeShock]    = (HcPlusL,  "感電している敵も2倍に数える参考の札（第217期・G3K・保持者 0 枚）"),
