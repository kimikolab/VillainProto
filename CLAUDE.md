...
**新しい則を足すとき**: `design/RULES_*.md` の末尾に次の ID（`R271` から）で本文を書き、
...
| 会戦と境界（持ち越し・回復・選択・**駒1枚のステージ単位の帰属**・**寿命の帳簿**・**序列が動くか**・**列の並べ方**・**線の引き直し**・**目的変数**・**相手ごとの序列**・**短い列**・**検証用マップ**・**道中の回復**・**斥候級**・**遊べる形**） | 第 100, 101, 102 / **156, 157, 158, 159, 161, 162, 163, 165, 166, 167, 168, 169** 期 |
...
| 表示と「見る」（`GodotApp` / `DemoApp` / 台本の窓口 / 盲点表 / 戦績パネル / 書き手 / 手番の外 / **遊べるマップ** / **情報の層** / **配置の図と封じ** / **拠点での組み直し** / **得損の線と敵の説明文**） | 第 97, 98, 99 / **123, 124, 125** / **169, 170, 171, 172, 173** 期 |
