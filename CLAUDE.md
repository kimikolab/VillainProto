...
現状値は **61編成**（**第147期。バサの転倒を混乱に置き換えた後**）で
...
| 被弾・移動・隣接・席（`seats2` / `reseat` / `confirm` / 情報セル） | 第 45, 46, 47 / 50, 52, 53, 59 / 62, 63, 64 / 89 / 107, 111, 113, 114, **144, 146, 147** 期 |
| 手番（のろま・号令・据え・再行動・尾灯・譲渡・**構えと中継**・**転倒**） | 第 36, 37 / 103, 104, 105, 106, 109, 110 / **136, 143, 144** 期 |
