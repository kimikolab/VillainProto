...
| 手番（のろま・号令・据え・再行動・尾灯・譲渡・**構えと中継**・**転倒**・**手番で撃つ**） | 第 36, 37 / 103, 104, 105, 106, 109, 110 / **136, 143, 144, 148** 期 |
...
| 波ルール（逆位・渇き・軛・粛・殉教・曝き）と波の分離度・**対称性** | 第 22, 25, 27, 34, 35, 40 / 44, 51, 54 / **132, 134** 期 |
