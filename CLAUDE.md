...
現状値は **61編成**（**第133期も盤面を1ビットも動かしていない**ので数字は第130期のまま）で
...
| 毒・燃焼（瘴気・澱み・着火・滲み則・火の粉・熾火・破裂・**配布**・**火勢**） | 第 57, 58, 59, 60 / 61, 87, 89, 90, 91, 96 / **130, 133** 期 |
...
| 波ルール（逆位・渇き・軛・粛・殉教・曝き）と波の分離度 | 第 22, 25, 27, 34, 35, 40 / 44, 51, 54 / **132** 期 |
