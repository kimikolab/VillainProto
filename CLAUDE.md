...
**新しい則を足すとき**: `design/RULES_*.md` の末尾に次の ID（`R244` から）で本文を書き、
...
| 会戦と境界（持ち越し・回復・選択・**駒1枚のステージ単位の帰属**・**寿命の帳簿**・**序列が動くか**・**列の並べ方**・**線の引き直し**・**目的変数**） | 第 100, 101, 102 / **156, 157, 158, 159, 161, 162** 期 |
