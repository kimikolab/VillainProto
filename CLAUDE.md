...
| R238 | 判定の線は、値ではなく量の定義で1つに決める（**線は「量の定義 ＋ 単位 ＋ その値が出た対照」の3点セット**） | 159/160/161 | 器具と測り方 | `RULES_174_242.md` |
...
**新しい則を足すとき**: `design/RULES_*.md` の末尾に次の ID（`R243` から）で本文を書き、
...
| 会戦と境界（持ち越し・回復・選択・**駒1枚のステージ単位の帰属**・**寿命の帳簿**・**序列が動くか**・**列の並べ方**・**線の引き直し**） | 第 100, 101, 102 / **156, 157, 158, 159, 161** 期 |
