...
所要は全編成でおおむね 10〜30秒、`bridge` だけ 30秒前後。
    ...
    dotnet run --project BattleSim -c Release 0 shard check docs/balance.md  # 自己検査（必須1 ＋ (a)〜(d)。**(b) は `Both`/0 が `Passive` と完全一致**）
...
| 死・破片・痺・召喚（墓守・分裂・蘇生・鱗・餌・**砕け**） | 第 47, 48, 49, 51, 59 / 103 / **137** 期 |
