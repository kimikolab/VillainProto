...
現状値は **61編成**（第130期。**段0 で第129期 段3 を巻き戻し、段1 は採用 0 件**）で
...
「発火の密度」（発火 ÷ 生存T）が<u>上がる</u>駒だったこと**——第129期 段2 の延命台
（代金ゼロの器具 `TraitId.Undying`）で 0.463 → 0.508 の **×1.10**。
他の4枚はソラ ×0.95・セロ ×0.74・ガルド ×0.65・トメ ×0.55 と**全部下がる。**
