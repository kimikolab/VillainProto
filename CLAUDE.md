...
現状値は **61編成**（**第139期。`溜め (ガン×ドルガ×カド)` → `礫 (ガレ×ヒビ×ウロ)` の差し替えの後**）で
...
| 手番（のろま・号令・据え・再行動・尾灯・譲渡・**構えと中継**） | 第 36, 37 / 103, 104, 105, 106, 109, 110 / **136** 期 |
| ボス（時間に比例する項・被害で育つ × 死なない・時間を買う機構） | 第 117, 118, **126, 129** 期 |
| 庇いと肩代わり（介入の鎖・死因の経路・無効化・**壁**） | 第 34, 35 / 89, 90 / 120, 125 / **135, 136** 期 |
| 攻撃型と段（格上げ・軋み・積み過ぎ・鱗・熾火・後衛特化・**上限と分布**） | 第 47, 66, 67, 77 / 115, 116, **127, 128, 132, 133** 期 |
| 死・破片・痺・召喚（墓守・分裂・蘇生・鱗・餌・**砕け**・**礫**） | 第 47, 48, 49, 51, 59 / 103 / **137, 138** 期 |
