...
## 構成と絶対のルール
    ...
    docs/           BattleSim が吐く生成物 12ファイル（balance / units / chain / ablation /
                    pulse / engage / layout / reseat ／ **crossing** ／ **rules** ／ **watch** ／ **quality**）。手で編集しない。整合は `audit` で見る
...
現状値は **61編成**（第127期。**据えのバンの積み過ぎを段違い版に差し替えた後**）で
...
| 弱体・強化（なまり・呪詛・萎縮・突き返し・引き受け・転嫁・横流し・火選り・呪い則・灯の濾し・積み過ぎ・糧） | 第 41, 42, 43, 44, 56 / 62, 63, 64, 65, 66, 67, 68, 77 / 95 / 106, 113, 114, 115, 116, 118 期 |
...
| 攻撃型と段（格上げ・軋み・積み過ぎ・鱗・熾火・後衛特化） | 第 47, 66, 67, 77 / 115, 116, **127** 期 |
