...
| 21 | `sever` | `SeverRule` | `SeverRule { Wait = Swing, Threshold = 2 }` |  | `wcost` / `ledger` / `cross` | 第74期〜（5 期） | ○ |
...
| 36 | `menderCost` | `MenderCostRule` | `MenderCostRule { Percent = 50 }` |  | `tempo` / `hold` / `hold2` / `ledger` | 第106期〜（3 期） | ○ |
| 37 | `loose` | `LooseRule` | `LooseRule { Shove = True }` |  | `tempo` / `hold` / `hold2` / `ledger` | 第106期〜（3 期） | ○ |
| 38 | `taillight` | `TaillightRule` | `TaillightRule { Mode = OwnTurnWindow }` |  | `tomo` / `ledger` | 第110期〜（2 期） | ○ |
...
| `LooseRule` | `LooseRule { Shove = True }` | ○ | `tempo` / `hold` / `hold2` / `ledger` | 第106期〜（3 期） |
...
| `MenderCostRule` | `MenderCostRule { Percent = 50 }` | ○ | `tempo` / `hold` / `hold2` / `ledger` | 第106期〜（3 期） |
...
| `SeverRule` | `SeverRule { Wait = Swing, Threshold = 2 }` | ○ | `wcost` / `ledger` / `cross` | 第74期〜（5 期） |
...
| `TaillightRule` | `TaillightRule { Mode = OwnTurnWindow }` | ○ | `tomo` / `ledger` | 第110期〜（2 期） |
