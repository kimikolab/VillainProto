...
| 28 | `gather` | `GatherRule` | `GatherRule { Enabled = True }` |  | `audit` / `derive` / `curse` / `hex` / `gather` / `deep` / `soak` / `cross` / `demo` | 第89期〜（9 期） | ○ |
...
| `GatherRule` | `GatherRule { Enabled = True }` | ○ | `audit` / `derive` / `curse` / `hex` / `gather` / `deep` / `soak` / `cross` / `demo` | 第89期〜（9 期） |
