...
| 50 | `shuffler` | `ShufflerRule` | `ShufflerRule { Foes = True, Stagger = Advanced }` |  | `tumult` / `confuse` | 第144期 | ○ |
...
| `ShufflerRule` | `ShufflerRule { Foes = True, Stagger = Advanced }` | ○ | `tumult` / `confuse` | 第144期 |
